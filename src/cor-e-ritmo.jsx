...
import adrianaImg from './images/adriana.jpg';
import claraImg from './images/clara.jpg';
import hugoImg from './images/hugo.jpg';
import capaImg from './images/capa.jpg';
import coresPrimariasImg from './images/cores-primarias.jpg';
import interacaoQuenteFriaImg from './images/interacao-quente-fria.jpg';
import sinestesia1Img from './images/sinestesia-1.jpg';
import sinestesia2Img from './images/sinestesia-2.jpg';
                    ...
                    <Stream d={400} speed={4}>
                        <div className="flex flex-col items-center bg-[#181825] p-6 rounded-xl border border-[#45475A] shadow-lg h-full">
                            <div className="w-28 h-28 rounded-full border-[4px] border-[#50FA7B] overflow-hidden mb-4 shrink-0">
                                <img src={adrianaImg} alt="Adriana" className="w-full h-full object-cover" />
                            </div>
                    ...
                    <Stream d={800} speed={4}>
                        <div className="flex flex-col items-center bg-[#181825] p-6 rounded-xl border border-[#45475A] shadow-lg h-full">
                            <div className="w-28 h-28 rounded-full border-[4px] border-[#FF79C6] overflow-hidden mb-4 shrink-0">
                                <img src={claraImg} alt="Clara" className="w-full h-full object-cover" />
                            </div>
                    ...
                    <Stream d={1200} speed={4}>
                        <div className="flex flex-col items-center bg-[#181825] p-6 rounded-xl border border-[#45475A] shadow-lg h-full">
                            <div className="w-28 h-28 rounded-full border-[4px] border-[#F1FA8C] overflow-hidden mb-4 shrink-0">
                                <img src={hugoImg} alt="Hugo" className="w-full h-full object-cover" />
                            </div>
                ...
                <div className="grid grid-cols-3 gap-6 w-full items-center">
                    ...
                    <Stream d={1000}>
                        <div className="w-fit h-fit mx-auto flex flex-col justify-center items-center rounded-xl overflow-hidden border-4 border-[#FF79C6] animate-[beat-pulse_3s_infinite_ease-in-out]">
                            <img src={capaImg} alt="Capa do Livro" className="h-auto w-auto max-h-[300px] max-w-full object-cover block" />
                        </div>
                    </Stream>
                    {/* Cores Primárias */}
                    <Stream d={1500}>
                        <div className="w-fit h-fit mx-auto flex flex-col justify-center items-center rounded-xl overflow-hidden border-4 border-[#8BE9FD] animate-[beat-pulse_3s_infinite_ease-in-out]">
                            <img src={coresPrimariasImg} alt="Cores Primárias" className="h-auto w-auto max-h-[300px] max-w-full object-cover block" />
                        </div>
                    </Stream>
                    {/* Exercício Interação */}
                    <Stream d={2000}>
                        <div className="w-fit h-fit mx-auto flex flex-col justify-center items-center rounded-xl overflow-hidden border-4 border-[#F1FA8C] animate-[beat-pulse_3s_infinite_ease-in-out]">
                            <img src={interacaoQuenteFriaImg} alt="Interação Quente e Fria" className="h-auto w-auto max-h-[300px] max-w-full object-cover block" />
                        </div>
                    </Stream>
                </div>
            ...
            <div className="flex flex-col flex-grow justify-center w-full">
                <div className="grid grid-cols-2 gap-12 w-full items-center">
                    ...
                    <div className="grid grid-rows-2 gap-6 h-full">
                        <Stream d={1200}>
                            <div className="w-fit h-fit mx-auto flex flex-col justify-center items-center rounded-xl overflow-hidden border-4 border-[#8BE9FD] animate-[beat-pulse_3s_infinite_ease-in-out]">
                                <img src={sinestesia1Img} alt="Print da Plataforma Sinestesia 1" className="h-auto w-auto max-h-[220px] max-w-full object-cover block" />
                            </div>
                        </Stream>
                        <Stream d={1800}>
                            <div className="w-fit h-fit mx-auto flex flex-col justify-center items-center rounded-xl overflow-hidden border-4 border-[#FF79C6] animate-[beat-pulse_3s_infinite_ease-in-out]" style={{ animationDelay: '1.5s' }}>
                                <img src={sinestesia2Img} alt="Print da Plataforma Sinestesia 2" className="h-auto w-auto max-h-[220px] max-w-full object-cover block" />
                            </div>
                        </Stream>
                    </div>
                </div>
